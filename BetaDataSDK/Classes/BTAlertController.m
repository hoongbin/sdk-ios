...
#pragma mark - BTAlertController
@interface BTAlertController () <UIAlertViewDelegate, UIActionSheetDelegate>

@property (nonatomic, strong) UIWindow *alertWindow;

@property (nonatomic, copy) NSString *alertTitle;
@property (nonatomic, copy) NSString *alertMessage;
@property (nonatomic) BTAlertControllerStyle preferredStyle;
...
- (void)show {
    ...
    } else if (self.preferredStyle == BTAlertControllerStyleAlert) {
        [self showAlertView];
    } else if (self.preferredStyle == BTAlertControllerStyleActionSheet) {
        [self showActionSheet];
    }
}

- (void)showAlertController {
    UIAlertControllerStyle style = self.preferredStyle == BTAlertControllerStyleAlert ? UIAlertControllerStyleAlert : UIAlertControllerStyleActionSheet;
