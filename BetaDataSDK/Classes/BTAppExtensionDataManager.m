//
//  BTAppExtensionDataManager.m
//  BetaDataSDK
//
//  Created by Zhou Kang on 2018/1/18.
...
@interface BTAppExtensionDataManager() {
}
@property(nonatomic,strong) dispatch_queue_t appExtensionQueue;
@end

@implementation BTAppExtensionDataManager

+ (instancetype)sharedInstance {
    static BTAppExtensionDataManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[BTAppExtensionDataManager alloc] init];
    });
    return manager;
}
    ...
    @try {
        ...
        dispatch_block_t block = ^{
            ...
            if(![[NSFileManager defaultManager]fileExistsAtPath:path]){
                ...
                if (success) {
                    BTLog(@"create plist file success!!!!!!! APPEXtension...");
                }
            }
