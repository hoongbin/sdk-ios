...
NSString *kBTReachabilityChangedNotification = @"kSANetworkReachabilityChangedNotification";

#pragma mark - BTReachability implementation

@implementation BTReachability
{
...
{
	BTReachability* returnValue = NULL;
