...
@interface BTObjectSerializer ()

@end

@implementation BTObjectSerializer {
    BTObjectSerializerConfig *_configuration;
    BTObjectIdentityProvider *_objectIdentityProvider;
}
...
- (NSDictionary *)serializedObjectsWithRootObject:(id)rootObject {
    ...
    BTObjectSerializerContext *context = [[BTObjectSerializerContext alloc] initWithRootObject:rootObject];
    ...
    @try {
        ...
        BTLog(@"Failed to serialize objects: %@", e);
    }
...
- (void)visitObject:(NSObject *)object withContext:(BTObjectSerializerContext *)context {
    ...
    BTClassDescription *classDescription = [self classDescriptionForObject:object];
    if (classDescription) {
        for (BTPropertyDescription *propertyDescription in [classDescription propertyDescriptions]) {
...
- (NSArray *)allValuesForType:(NSString *)typeName {
    ...
    BTTypeDescription *typeDescription = [_configuration typeWithName:typeName];
    if ([typeDescription isKindOfClass:[BTEnumDescription class]]) {
        BTEnumDescription *enumDescription = (BTEnumDescription *)typeDescription;
...
- (id)instanceVariableValueForObject:(id)object
                 propertyDescription:(BTPropertyDescription *)propertyDescription {
    NSParameterAssert(object != nil);
...
propertyDescription:(BTPropertyDescription *)propertyDescription
            context:(BTObjectSerializerContext *)context {
...
- (id)propertyValueForObject:(NSObject *)object
     withPropertyDescription:(BTPropertyDescription *)propertyDescription
                     context:(BTObjectSerializerContext *)context {
...
- (BTClassDescription *)classDescriptionForObject:(NSObject *)object {
    NSParameterAssert(object != nil);

    Class aClass = [object class];
    while (aClass != nil) {
        BTClassDescription *classDescription = [_configuration classWithName:NSStringFromClass(aClass)];
        if (classDescription) {
